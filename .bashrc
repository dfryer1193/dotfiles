...
alias aurinst='aurget -Sy --deps --noedit --noconfirm --force'
alias aurbuild='aurget -Sb --deps --noedit --noconfirm --force --nodiscard'
alias aurupgr='aurget -Syu --deps --noedit --noconfirm --force'
