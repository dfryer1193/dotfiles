...
alias clc='clear'
alias qq='exit'
alias aursearch='aurget -Ss --aur4'
alias aurinst='aurget -Sy --deps --noedit --noconfirm --aur4'
alias aurbuild='aurget -Sb --deps --noedit --noconfirm  --nodiscard --aur4'
alias aurupgr='aurget -Syu --deps --noedit --noconfirm --aur4'
